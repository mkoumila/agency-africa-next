        ...
        <div className="flex flex-col lg:flex-row lg:gap-8 lg:justify-between lg:items-baseline">
          ...
          <Animate animationType="fade" direction="right">
            <div className="font-sofia font-normal leading-6 lg:max-w-[424px]">
              ...
              <p className="mb-4">
                Nous concevons et réalisons des films, campagnes et dispositifs
                de communication pour des entreprises panafricaines et
              ...
              <p className="mb-4">
                Avec nos clients, nous construisons des récits de marque avec
                une approche centrée sur l'émotion, l'engagement et la
                performance pour des audiences corporate comme grand public.
              </p>
